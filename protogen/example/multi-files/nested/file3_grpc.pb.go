...
const (
	Gripmock2_SayHello_FullMethodName = "/multifiles.nested.Gripmock2/SayHello"
)
...
func (c *gripmock2Client) SayHello(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Reply, error) {
...
func (UnimplementedGripmock2Server) SayHello(context.Context, *Request) (*Reply, error) {
...
func _Gripmock2_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(Gripmock2Server).SayHello(ctx, req.(*Request))
	}
...
var Gripmock2_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "multifiles.nested.Gripmock2",
