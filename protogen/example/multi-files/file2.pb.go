...
var file_file2_proto_rawDesc = []byte{
	...
	0x32, 0x42, 0x38, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
...
func file_file2_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_file2_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_file2_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Reply2); i {
			case 0:
				return &v.state
			case 1:
