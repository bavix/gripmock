...
func file_oneof_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_oneof_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_oneof_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Reply); i {
			case 0:
				return &v.state
			case 1:
		...
		file_oneof_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Reply1); i {
			case 0:
				return &v.state
			case 1:
		...
		file_oneof_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Reply2); i {
			case 0:
				return &v.state
			case 1:
