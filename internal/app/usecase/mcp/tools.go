...
const (
	ToolHealthLiveness  = "health_liveness"
	ToolHealthReadiness = "health_readiness"
	ToolHealthStatus    = "health_status"

	ToolDashboard = "dashboard_full"
	ToolOverview  = "dashboard_overview"
	ToolInfo      = "dashboard_info"

	ToolSessionsList   = "sessions_list"
	ToolGripmockInfo   = "gripmock_info"
	ToolReflectInfo    = "reflect_info"
	ToolReflectSources = "reflect_sources"

	ToolDescriptorsAdd  = "descriptors_add"
	ToolDescriptorsList = "descriptors_list"
	ToolServicesGet     = "services_get"
	ToolServicesMethods = "services_methods"
	ToolServicesMethod  = "services_method"
	ToolServicesList    = "services_list"
	...
	ToolStubsBatchDelete = "stubs_batch_delete"
