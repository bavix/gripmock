...
### Pruebas del gateway (ConnectRPC y gRPC-Web)

grpctestify habla los tres protocolos, así que los mismos archivos `.gctf` deben
pasar sobre cada uno. Apúntelo al puerto del gateway y cambie el protocolo:
